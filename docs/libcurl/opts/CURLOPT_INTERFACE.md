...
outgoing network interface. By default, the name can be an interface name,
an IP address, or a hostname. If you explicitly prefer one of these, you
can use the following special prefixes:
